	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="home.html">Hogar</a></li>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Crea tu propia cuenta de Compra</p>
...
<div class="form-group">
	    	<label class="info-title" for="contactno">Nº de contacto<span>*</span></label>
...
<div class="form-group">
	    	<label class="info-title" for="confirmpassword">Confirme la contraseña<span>*</span></label>
	    	<input type="password" class="form-control unicase-form-control text-input" id="confirmpassword" name="confirmpassword" required >
	  	</div>


	  	<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button" id="submit">Únete</button>
	</form>
	<span class="checkout-subtitle outer-top-xs">Regístrese hoy y podrá :  </span>
	<div class="checkbox">
	  	<label class="checkbox">
		  Acelera tu camino a través del proceso de pago.
		</label>
		<label class="checkbox">
