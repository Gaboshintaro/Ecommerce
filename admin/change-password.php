					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Administrador Cambiar contraseña</h3>
							</div>
...
<div class="controls">
<input type="password" placeholder="Ingrese su nueva contraseña actual"  name="newpassword" class="span8 tip" required>
</div>
</div>
...
<label class="control-label" for="basicinput">Contraseña actual</label>
<div class="controls">
<input type="password" placeholder="Ingresa tu nueva contraseña nuevamente"  name="confirmpassword" class="span8 tip" required>
</div>
</div>
