...
$st='Delivered';
   ...
   <?php }else  {
    ...
    <tr height="50">
      <td class="fontkink1">Estatus: </td>
      <td  class="fontkink"><span class="fontkink1" >
        <select name="status" class="fontkink" required="required" >
          <option value="">Seleccionar estado</option>
                 <option value="in Process">En proceso</option>
                 <option value="On the ways">En camino</option>
    ...
    <tr>
      ...
      <td  class="fontkink"> <input type="submit" name="submit2"  value="Actualizar estado"   size="40" style="cursor: pointer;" /> &nbsp;&nbsp;   
      <input name="Submit2" type="submit" class="txtbox4" value="Cerrar" onClick="return f2();" style="cursor: pointer;"  /></td>
    </tr>
<?php } ?>
</table>
 </form>
