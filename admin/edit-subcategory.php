...
{?>
									...
									<strong>Bien hecho se actualizo la SUBCATEGORIA!</strong> <!-- <?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?> -->
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nombre de la subcaregoria</label>
<div class="controls">
