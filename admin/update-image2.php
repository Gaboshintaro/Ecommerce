					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar la imagen del producto 2</h3>
							</div>
...
{?>
									...
									<strong>Bien hecho se actualizo la IMAGEN 2!</strong>	<!-- <?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?> -->
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen de nuevo producto2</label>
<div class="controls">
