					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar la imagen del producto 1</h3>
							</div>
...
{?>
									...
									<strong>Bien hecho se actualizo la IMAGEN 1!</strong>	<!-- <?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>-->
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva imagen de producto1</label>
<div class="controls">
