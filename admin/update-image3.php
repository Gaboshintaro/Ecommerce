					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar la imagen del producto 3</h3>
							</div>
...
{?>
									...
									<strong>Bien hecho se actualizo la IMAGEN 3!</strong>	<!--<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?> -->
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen actual del producto3</label>
<div class="controls">
