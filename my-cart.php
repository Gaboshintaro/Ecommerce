		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total last-item">Total a pagar</th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<input type="submit" name="submit" value="Actualizar el carrito de compra" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
<div class="form-group">
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Código de facturación<span>*</span></label>
...
<div class="form-group">
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Código de envío<span>*</span></label>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total a pagar<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">Ir a pagar</button>
